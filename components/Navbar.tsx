...
export default function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      {/* FULL-WIDTH NAV (no top whitespace, bg/shadow unchanged) */}
      <nav
        className="
          w-full
        ...
        "
      >
        {/* Inner container to keep layout like before */}
        <div className="mx-auto w-[min(1200px,calc(100%-24px))]">
          ...
          {/* Mobile CTA line under header row */}
